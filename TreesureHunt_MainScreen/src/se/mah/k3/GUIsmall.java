...
public class GUIsmall extends JFrame {
	...
	private int[] sidebarPosition = {864,5};
	private int[] sidebarSize = {150, 552}; // control both the scaling of the sidebarImg and the size of the JLabel
	...
	public void setupFrameElements(){
		...
		logo_label.setBounds(sidebarPosition[0]+15, 22, sidebarSize[0]-30, sidebarSize[0]-30 );
		logo_label.setIcon(new ImageIcon(logoImg.getScaledInstance(sidebarSize[0]-30, sidebarSize[0]-30, Image.SCALE_SMOOTH)));
		background_panel.add(logo_label);
		
		//LOGOTEXT
		logotext_label = new JLabel();
		logotext_label.setBounds(sidebarPosition[0]+15, 148, 120, 73 );
		logotext_label.setIcon(new ImageIcon(logotextImg.getScaledInstance(120, 73, Image.SCALE_SMOOTH)));
		background_panel.add(logotext_label);
		
		//ANIMATION
		animation_label = new JLabel();
		animation_label.setBounds(sidebarPosition[0]+10, 285, 130, 130 );
		animation_label.setIcon(helpAni);
		background_panel.add(animation_label);
		
		//GOOGLE
		download_label = new JLabel();
		download_label.setBounds(sidebarPosition[0]+20, 490, 115, 40 );
		download_label.setIcon(new ImageIcon(googleImg.getScaledInstance(115, 40, Image.SCALE_SMOOTH)));
